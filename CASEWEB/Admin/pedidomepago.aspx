<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="pedidomepago.aspx.cs" Inherits="CASEWEB.Admin.pedidomepago" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
   ...
   <h2 style="text-align: center; color: #333; margin-bottom: 10px;"><strong>Reporte:</strong> Pedidos por metodo de pago</h2>

    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:cs %>" SelectCommand="SELECT PRODUCTOS.Nombre_Pro, ORDEN.NumOrden_Ord, ORDEN.Cantidad_Ord, PAGO.ModoPago_Pag
FROM     PAGO INNER JOIN
                  ORDEN ON PAGO.Cod_Pag = ORDEN.Cod_Pag INNER JOIN
                  PRODUCTOS ON ORDEN.Cod_Pro = PRODUCTOS.Cod_Pro"></asp:SqlDataSource>
    <style type="text/css">
        .btnExportContainer {
            text-align: center;
        }
   ...
   <div style="text-align: center; margin-bottom: 20px;">
    ...
    <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
        <Report FileName="pedidomepago.rpt"></Report>
