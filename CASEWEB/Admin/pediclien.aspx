...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  ...
  <h2 style="text-align: center; color: #333; margin-bottom: 10px;"><strong>Reporte:</strong> Pedidos por cliente</h2>
   <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:cs %>" SelectCommand="SELECT ORDEN.NumOrden_Ord, USUARIOS.Nombre_Usu, USUARIOS.Telefono_Usu, ORDEN.Estado_Ord, ORDEN.Fecha_Ord FROM ORDEN INNER JOIN USUARIOS ON ORDEN.Cod_Usu = USUARIOS.Cod_Usu"></asp:SqlDataSource>
