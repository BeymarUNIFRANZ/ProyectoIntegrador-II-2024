<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="registroclientes.aspx.cs" Inherits="CASEWEB.Admin.registroclientes1" %>
<%@ Register Assembly="CrystalDecisions.Web, Version=13.0.4000.0, Culture=neutral, PublicKeyToken=692fbea5521e1304" Namespace="CrystalDecisions.Web" TagPrefix="CR" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
          <!-- Agregar un título con subtítulo en negritas -->
   <h2 style="text-align: center; color: #333; margin-bottom: 10px;"><strong>Reporte:</strong>Clientes activos vs. inactivos</h2>
    <br />

    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:cs %>" SelectCommand="SELECT Nombre_Usu, NombreUsuario_Usu, Telefono_Usu, Correo_Usu, CreadoFecha_Usu, Cod_Usu FROM USUARIOS"></asp:SqlDataSource>
