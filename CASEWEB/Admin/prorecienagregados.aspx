<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="prorecienagregados.aspx.cs" Inherits="CASEWEB.Admin.prorecienagregados1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  ...
  <h2 style="text-align: center; color: #333; margin-bottom: 10px;"><strong>Reporte:</strong> Productos recientemente agregados</h2>
   <br />

   <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:cs %>" SelectCommand="SELECT TOP (10) Cod_Pro, Nombre_Pro, Precio_Pro, Cantidad_Pro AS TotalVendido FROM PRODUCTOS ORDER BY TotalVendido DESC"></asp:SqlDataSource>
    <!-- CrystalReportViewer para mostrar el reporte -->
