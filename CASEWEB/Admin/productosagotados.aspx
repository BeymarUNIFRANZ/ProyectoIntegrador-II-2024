<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="productosagotados.aspx.cs" Inherits="CASEWEB.Admin.productosagotados" %>
<%@ Register Assembly="CrystalDecisions.Web, Version=13.0.4000.0, Culture=neutral, PublicKeyToken=692fbea5521e1304" Namespace="CrystalDecisions.Web" TagPrefix="CR" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
          <!-- Agregar un título con subtítulo en negritas -->
   <h2 style="text-align: center; color: #333; margin-bottom: 10px;"><strong>Reporte:</strong> Lista de productos agotados</h2>
        <style type="text/css">
        .btnExportContainer {
            text-align: center;
        }
   ...
   <div style="text-align: center; margin-bottom: 20px;">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:cs %>" SelectCommand="SELECT Nombre_Pro, Descripcion_Pro, Precio_Pro, Cantidad_Pro, Cod_Pro FROM PRODUCTOS"></asp:SqlDataSource>
    ...
    <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
        <Report FileName="productosagotados.rpt"></Report>
