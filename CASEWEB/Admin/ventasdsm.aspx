<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="ventasdsm.aspx.cs" Inherits="CASEWEB.Admin.ventasdsm1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
             <!-- Agregar un título con subtítulo en negritas -->
  <h2 style="text-align: center; color: #333; margin-bottom: 10px;"><strong>Reporte:</strong> Listado de venta por mes</h2>
                <style type="text/css">
        .btnExportContainer {
            text-align: center;
        }
