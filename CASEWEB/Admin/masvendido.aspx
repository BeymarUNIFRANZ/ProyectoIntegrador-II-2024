<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="masvendido.aspx.cs" Inherits="CASEWEB.Admin.masvendido1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <h2 style="text-align: center; color: #333; margin-bottom: 10px;"><strong>Reporte:</strong> Productos mas vendidos</h2>
    <br />
    ...
    <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
        <Report FileName="masvendido.rpt"></Report>
