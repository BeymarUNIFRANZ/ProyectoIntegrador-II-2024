<%@ Page Title="" Language="C#" MasterPageFile="~/Usuario/Usuario.Master" AutoEventWireup="true" CodeBehind="Carrito.aspx.cs" Inherits="CASEWEB.Usuario.Carrito" %>
            ...
            <asp:Repeater ID="rCartItem" runat="server" OnItemCommand="rCartItem_ItemCommand" OnItemDataBound="rCartItem_ItemDataBound">
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td>
                            <img width="60" src="<%# Utils.GetImageUrl(Eval("ImagenUrl_Pro")) %>" alt="" />
                        </td>
                        <td>Bs<asp:Label ID="lblPrice" runat="server" Text='<%# Eval("Precio_Pro") %>'></asp:Label>
                            <asp:HiddenField ID="hdnProductId" runat="server" Value='<%# Eval("Cod_Pro") %>' />
                        ...
                        <td>
                            <div class="product__details__option">
                                <div class="quantity">
                                    <div class="pro-qty">
                                        <asp:TextBox ID="txtQuantity" runat="server" TextMode="Number" Text='<%# Eval("Cantidad_Car") %>'>
                                        </asp:TextBox>
                        ...
                        <td>Bs<asp:Label ID="lblTotalPrice" runat="server"></asp:Label></td>
                        <td>
                            <asp:LinkButton ID="lbDelete" runat="server" Text="Remove" CommandName="remove"
                                CommandArgument='<%# Eval("Cod_Pro") %>'
                                OnClientClick="return confirm('Quieres quitar este Producto de tu Carrito?');"> 
                ...
                <FooterTemplate>
                    <tr>
                        ...
                        <td>Bs<% Response.Write(Session["TotalPrecio"]); %></td>
                        <td></td>
                    </tr>
                    <tr>
                        <td colspan="2" class="continue__btn">
                            <a href="Menu.aspx" class="btn btn-info"><i class="fa fa-arrow-circle-left mr-2"></i>Seguir Comprando </a>
                        </td>
                        <td>
                        ...
                        <td>
                           ...
                           Confirmar <i class="fa fa-arrow-circle-rigth ml-2"></i>
                            </asp:LinkButton>
                        </td>
                    </tr>
                    </tbody>
