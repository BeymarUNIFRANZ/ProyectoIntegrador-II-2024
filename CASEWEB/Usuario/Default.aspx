      ...
      <div class="container ">
        <div class="row">
          <div class="col-md-6  ">
            <div class="box ">
              <div class="img-box">
                <img src="../PlantillaArchivos/images/o1.jpg" alt="">
              </div>
          ...
          <div class="col-md-6  ">
            <div class="box ">
              <div class="img-box">
                <img src="../PlantillaArchivos/images/o2.jpg" alt="">
              </div>
              <div class="detail-box">
                <h5>
                  Pizza Days
        ...
        <div class="owl-carousel client_owl-carousel">
          <div class="item">
            <div class="box">
              ...
              <div class="img-box">
                <img src="../PlantillaArchivos/images/client1.jpg" alt="" class="box-img">
              </div>
            </div>
          </div>
          <div class="item">
            <div class="box">
              ...
              <div class="img-box">
                <img src="../PlantillaArchivos/images/client2.jpg" alt="" class="box-img">
              </div>
            </div>
          </div>
        </div>
