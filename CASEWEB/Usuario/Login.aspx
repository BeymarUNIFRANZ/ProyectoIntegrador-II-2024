<%@ Page Title="" Language="C#" MasterPageFile="~/Usuario/Usuario.Master" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="CASEWEB.Usuario.Login" %>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form_container">
                        ...
                        <img id="userLogin" src="../Images/alpacaLOGIN.jpg" alt="" class="img-thumbnail" />
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form_container">
                        <div>
                            <asp:RequiredFieldValidator ID="rfvUsername" runat="server"
                                ErrorMessage="Requiere su Nombre de Usuario" ControlToValidate="txtUsername"
