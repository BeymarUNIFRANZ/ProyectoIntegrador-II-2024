<%@ Page Title="" Language="C#" MasterPageFile="~/Vendedor/Vendedor.Master" AutoEventWireup="true" CodeBehind="pediclien.aspx.cs" Inherits="CASEWEB.Vendedor.pediclien1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:OficialConnectionString %>" SelectCommand="SELECT ORDEN.NumOrden_Ord, USUARIOS.Nombre_Usu, USUARIOS.Telefono_Usu, ORDEN.Estado_Ord, ORDEN.Fecha_Ord FROM ORDEN INNER JOIN USUARIOS ON ORDEN.Cod_Usu = USUARIOS.Cod_Usu"></asp:SqlDataSource>
